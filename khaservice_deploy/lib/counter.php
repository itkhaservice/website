...
// khoảng thời gian chờ để tính một kết nối mới (tính bằng giây)
// lưu lại IP của kết nối
require_once('connect.php');    
// nhúng file kết nối CSDL vào
...
// z- là số thứ tự ngày trong năm, năm đây là năm có 365 ngày
...
// đếm số người ghé thăm ngày hôm qua
// . (date('z') +1+ 0) .  =  . (date('z') + 1 ) .  =>  . (date('z') + 1 - 1 ) . = . (date('z') + 0) .
// lùi lại 1 ngày nên trừ đi 1
...
// đếm số người ghé thăm tuần rồi
//. date('W') . =. (date('W') ). =. (date('W') + 0 ).  => . (date('W') + 0 -1 ). . (date('W')  -1 ). 
// lùi lại 1 tuần nên trừ 1
