...
-- Generation Time: Dec 29, 2025 at 05:01 AM
...
--
-- Database: `if0_40778649_khaservice_db`
--
...
(1, 'Cao Minh Thắng', '+84376701749', 'thangminhcaoss@gmail.com', NULL, NULL, 'Tuyển dụng vị trí iT', 1766733026, 1);
...
(38, 1, 'Song Da Tower', 'song-da-tower', 'img/portfolio/5.jpg', 'Song Da Tower', '<p>Song Da Tower<br></p>', 'du-an', 0, 1, 1, 0, 1726042021, 1726130966, NULL, NULL, NULL, 1),
...
(1, '11+ Năm kinh nghiệm', 'Với hơn 10.000+ căn hộ v&agrave; căn biệt thự do KhaService quản l&yacute;', '', 1, 1, NULL, 1766977971),
(2, 'Đội ngũ chuyên nghiệp - tận tâm', 'Đội ngũ được đ&agrave;o tạo chuy&ecirc;n nghiệp. Lu&ocirc;n tận t&acirc;m, hết m&igrave;nh v&igrave; quyền lợi của kh&aacute;ch h&agrave;ng', '', 2, 1, NULL, 1766977976),
...
CREATE TABLE `table_khuvuc` (
  `id` int(11) NOT NULL,
  `ten_vi` varchar(255) DEFAULT NULL,
  `ten_khong_dau` varchar(255) DEFAULT '',
  `noidung_vi` text DEFAULT NULL,
  `type` varchar(50) DEFAULT NULL,
  `stt` int(11) DEFAULT 1,
  `hienthi` tinyint(1) DEFAULT 1,
...
INSERT INTO `table_khuvuc` (`id`, `ten_vi`, `ten_khong_dau`, `noidung_vi`, `type`, `stt`, `hienthi`, `ngaytao`, `ngaysua`, `title`, `keywords`, `description`) VALUES
(1, 'Quận 1 - Quận 3', 'quan-1---quan-3', 'Khu vực Quận 1', 'du-an', 1, 1, 1724037523, 1725851129, '', '', ''),
(4, 'Quận 4 - Quận 8', 'quan-4---quan-8', 'Khu vực Quận 4', 'du-an', 2, 1, 1724041939, 1725851145, '', '', ''),
(7, 'Quận 7', 'quan-7', 'Khu vực Quận 7', 'du-an', 3, 1, 1724056951, 1724056951, '', '', ''),
(9, 'Thành Phố Thủ Đức', 'thanh-pho-thu-duc', 'Khu vực Thành Phố Thủ Đức', 'du-an', 4, 1, 1724056983, 1724056983, '', '', ''),
(10, 'Bình Tân - Bình Chánh', 'binh-tan---binh-chanh', 'Quận Bình Tân - Bình Chánh', 'du-an', 5, 1, 1724057008, 1725854010, '', '', ''),
(11, 'Nhà Bè', 'nha-be', 'Huyện Nhà Bè', 'du-an', 6, 1, 1724057017, 1725854018, '', '', ''),
(12, 'Bình Dương', 'binh-duong', 'Khu vực Bình Dương', 'du-an', 7, 1, 1724057059, 1724057059, '', '', '');
...
CREATE TABLE `table_setting` (
  ...
  `link_phanmem` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `link_gioithieu_app` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'CÔNG TY CỔ PHẦN QUẢN LÝ VÀ VẬN HÀNH CAO ỐC KHÁNH HỘI', 'Tầng 1, Khu Thương Mại, 360C Bến Vân Đồn, Phường Vĩnh Hội, Thành phố Hồ Chí Minh, Việt Nam', '0918 754 277', '(028) 38 253 041', 'info@khaservice.com.vn', 'https://www.facebook.com/khaservice.official', 'https://www.facebook.com/khaservice.official', 'https://www.youtube.com/@khaservice', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.74182774098!2d106.68799657480454!3d10.75436968939307!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f0fc935b50d%3A0x9d94fe957e188526!2zQ8OUTkcgVFkgQ-G7lCBQSOG6pk4gUVXhuqJOIEzDnSBWw4AgVuG6rE4gSMOATkggQ0FPIOG7kEMgS0jDgU5IIEjhu5hJ!5e0!3m2!1svi!2s!4v1723194614330!5m2!1svi!2s\" width=\"100%\" height=\"auto\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 'https://www.youtube.com/watch?v=BwUaGq-nQ9Q', '', '', '', 'upload/caidat/1766653942_596.png', 'upload/caidat/1766653960_595.png', 'CÔNG TY CỔ PHẦN QUẢN LÝ VÀ VẬN HÀNH CAO ỐC KHÁNH HỘI', 'KHANH HOI BUILDING AND MANANGEMENT JOINT STOCK COMPANY', 'KHASERVICE', '0310341786', 'https://www.tiktok.com/@khaservice.official', 'https://www.youtube.com/watch?v=BwUaGq-nQ9Q', '', 'thanhhuyen@khaservice.com.vn', '0987 374 237', 'https://qlvh.khaservice.com.vn/login', 'https://khaservice.free.nf/gioi-thieu/ung-dung-danh-cho-cu-dan.html');
